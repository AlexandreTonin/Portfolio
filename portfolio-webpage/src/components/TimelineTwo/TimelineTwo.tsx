                    ...
                    <div className="relative col-span-12 lg:px-4 lg:space-y-6 sm:col-span-9">
                        <div className="col-span-12 lg:space-y-12 relative lg:px-4 sm:col-span-8 sm:space-y-8 sm:before:absolute sm:before:top-2 sm:before:bottom-0 sm:before:w-0.5 sm:before:-left-3 before:bg-gray-300 before:dark:bg-gray-700">
                            <RevealWrapper delay={750} duration={500} className="load-hidden">
                                <TimelineTwoItem role="Assistente de Sistemas" company="Unimed Noroeste RS" time="03/2024 - até o momento" description="Suporte ao cliente interno no sistema de gestão hospitalar Philips Tasy. Desenvolvimento de scripts PL/SQL (Oracle) para geração de relatórios e manipulação de dados. Desenvolvimento de aplicações web e integrações entre sistemas para automatizar processos internos." />
                                <TimelineTwoItem role="Auxiliar de Sistemas" company="Unimed Noroeste RS" time="08/2023 - 03/2024"/>
