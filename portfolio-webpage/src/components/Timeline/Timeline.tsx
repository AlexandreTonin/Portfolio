                        ...
                        <div className="w-full h-full">
                            <div className="relative wrap overflow-hidden lg:p-10 h-full">
                                ...
                                <RevealWrapper delay={1000} duration={500} className="load-hidden ">
                                    ...
                                    <TimelineItem className=" flex-row-reverse lg:text-right" title="Hora de Codar" date="(2023)" course="NodeJs" description="Curso de NodeJs, que aborda os conceitos básicos e avançados de NodeJs, como fundamentos, Core Modules, NPM, API's, Express, Handlebars, MongoDB, MySql, Arquitetura MVC, entre outros." andamento url="https://www.udemy.com/course/nodejs-do-zero-a-maestria-com-diversos-projetos" />
