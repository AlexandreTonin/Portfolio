                        ...
                        <div className="w-full h-full">
                            <div className="relative wrap overflow-hidden lg:p-10 h-full">
                                ...
                                <RevealWrapper delay={1000} duration={500} className="load-hidden ">
                                    <TimelineItem className="flex-row-reverse lg:text-right" title="Unijuí" date="(2022 - 2026)" course="Bacharelado em Engenharia de Software" description="Em 2022, iniciei o curso de Engenharia de Software, atualmente estou no 5º semestre. No decorrer do curso, explorei diversos tópicos essenciais de engenharia, engenharia de software, computação e modelagem matemática." andamento url="https://www.unijui.edu.br/estude/graduacao/cursos/engenharia-de-software-bacharelado-289" certifiedUrl="/matricula.pdf" certified />
                                    ...
                                    <TimelineItem className=" flex-row-reverse lg:text-right" title="Hora de Codar" date="(2023)" course="NodeJs" description="Curso de NodeJs, que aborda os conceitos básicos e avançados de NodeJs, como fundamentos, Core Modules, NPM, API's, Express, Handlebars, MongoDB, MySql, Arquitetura MVC, entre outros." url="https://www.udemy.com/course/nodejs-do-zero-a-maestria-com-diversos-projetos" certified certifiedUrl="https://www.udemy.com/certificate/UC-3ce208b9-28f8-4a8b-a2e8-0ad4b6e41a97/"/>
